        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="bg-card/50 hover:border-primary transition-colors">
            ...
            <CardContent>
              ...
              <Button asChild className="w-full bg-gradient-primary hover:opacity-90 text-primary-foreground">
          ...
          <Card className="bg-card/50 hover:border-primary transition-colors">
            ...
            <CardContent>
              ...
              <Button asChild className="w-full bg-gradient-primary hover:opacity-90 text-primary-foreground">
                <Link to="/admin/revenues">View Reports</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card/50 hover:border-primary transition-colors">
            ...
            <CardContent>
              ...
              <Button asChild className="w-full bg-gradient-primary hover:opacity-90 text-primary-foreground">
                <Link to="/admin/packages">Edit Packages</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
